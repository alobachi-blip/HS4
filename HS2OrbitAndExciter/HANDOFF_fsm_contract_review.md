...
遊戲內回歸驗 §11（見下）後可收工或修回歸。

**遊戲內建議驗：**
1. Ctrl+Shift+O 開協助→相機繞身體軸；躺姿仍繞軀幹軸非鉛垂。
2. V 停轉：流程／FEEL 續走；HUD 顯示「停轉」；停轉時換衣暫停。
3. V 再按恢復轉；換焦（Q／W／E）不丟人；每圈相對角與遠近有變。
4. 換衣仍綁圈數；穿牆靠 Shield。
...
契約實作切片已全部落地。請遊戲內驗 §11；停環視鍵目前為 **V**，若衝突請告知要改哪一鍵。
